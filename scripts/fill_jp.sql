...
INSERT INTO `jurassicParkDB`.`school_telephone` (`telephone`,`school_code`,`school_id`) 
  VALUES 
    ('orci.Ut@maurisrhoncus.net','2DE25B7D-0B7F-84CC-9D91-00B572622A8C',1),
    ('nec.orci.Donec@eunequepellentesque.net','2DE25B7D-0B7F-84CC-9D91-00B572622A8C',1),
    ('dolor.sit@quamquisdiam.org','A37E9258-37E3-AAF2-7D65-FB60E1C8F80C',2),
    ('magna.a.tortor@euismodestarcu.com','A37E9258-37E3-AAF2-7D65-FB60E1C8F80C',2),
    ('mauris.ut.mi@pharetra.org','8E70C8BE-8947-F7B2-612A-ACD3D1354D59',3),
    ('Duis@inhendrerit.ca','8E70C8BE-8947-F7B2-612A-ACD3D1354D59',3),
    ('molestie.in@neque.org','655D225F-7236-3A69-46D3-42A731E7731A',4),
    ('magna.Cras@Aliquamfringillacursus.com','655D225F-7236-3A69-46D3-42A731E7731A',4);
...
INSERT INTO `jurassicParkDB`.`reservation` (`school_code`,`school_id`,`visit_date`,`method`)
  VALUES
    ('A37E9258-37E3-AAF2-7D65-FB60E1C8F80C',2,'2018-03-04 03:03:13','email'),
    ('A37E9258-37E3-AAF2-7D65-FB60E1C8F80C',2,'2017-06-30 13:06:17','email'),
    ('655D225F-7236-3A69-46D3-42A731E7731A',4,'2016-12-03 01:12:23','telephone'),
    ('A37E9258-37E3-AAF2-7D65-FB60E1C8F80C',2,'2017-10-26 15:10:11','telephone'),
    ('A37E9258-37E3-AAF2-7D65-FB60E1C8F80C',2,'2017-04-29 00:04:49','email'),
    ('A37E9258-37E3-AAF2-7D65-FB60E1C8F80C',2,'2016-06-06 10:06:08','email'),
    ('2DE25B7D-0B7F-84CC-9D91-00B572622A8C',1,'2017-03-07 06:03:58','telephone'),
...
INSERT INTO `jurassicParkDB`.`product_visit` (`visit_type_id`,`visit_type_code`,`cost`)
  VALUES
    (1,'98E9D98F-98E8-3738-E79E-5646B0445B95',200.99),
    (2,'202410DD-4F78-E776-D2B4-9341C5FBC6EF',349.99),
    (3,'DCF5F5C3-4EE9-2EA3-135C-0E994BE65873',400.99),
    (4,'A3177A26-C487-4FF1-809A-1D52650FEDB4',500.99);
...
INSERT INTO `jurassicParkDB`.`employee` (`rfc`,`names`,`father_last_name`,`mother_last_name`,`email`,`telephone`,`day_off`) 
	VALUES
		('FAFE630306MJ3','Dara','Hunt','Conrad','enim.sit@quisdiamPellentesque.net','746-0490','Lunes'),
        ('GAMF720810GM2','Omar','Tate','Chapman','ut.quam@Aliquamfringilla.ca','1-908-412-1701','Martes'),
        ('KAGE8510097X6','Kareem','Becker','Medina','mauris@porttitorvulputateposuere.org','1-849-447-3575','Miercoles'),
        ('RDA1210113Q2','Ann','Peterson','Chan','nisi@Duisrisusodio.co.uk','394-8415','Jueves'),
        ('CSQ780524D56','Judah','Christian','Neal','Curabitur@malesuadaInteger.co.uk','1-911-936-2526','Viernes'),
        ('VAMM700702DD1','Martena','Cole','Frazier','in.consequat.enim@ut.co.uk','1-611-252-1831','Sabado'),
        ('NIRC590925R20','Lenore','Lucas','Wooten','pede.Cum.sociis@Nunc.net','856-4242','Domingo'),
        ('MOCE881119LV2','Kirestin','Randolph','Watts','ridiculus.mus@miloremvehicula.org','1-330-160-2859','Lunes'),
        ('RCO060224JI8','Kasper','Higgins','Woods','quis@nullaDonecnon.edu','1-890-834-2208','Martes'),
        ('MAPJ620315NDA','Cullen','Irwin','Thompson','sit@odiosagittissemper.net','918-6598','Miercoles'),
        ('FTM981104540','Hayfa','Odonnell','Greene','eleifend.non@orcilacusvestibulum.org','926-6330','Jueves'),
        ('ROSA661021P62','Lamar','Mendoza','Hendrix','luctus@sagittisplaceratCras.org','747-7511','Viernes'),
        ('APS110125924','Jasper','Cobb','Gay','tempor.augue.ac@molestiepharetra.ca','143-1429','Sabado'),
        ('AUAC8407293U6','Victoria','Phelps','Waters','non.vestibulum.nec@Aliquamornarelibero.ca','1-254-249-9971','Domingo'),
        ('RORV791020JC4','Inga','Gallegos','Strickland','Mauris@massaVestibulumaccumsan.co.uk','1-426-595-9570','Lunes'),
        ('AEC810901298','Kylee','Wiley','Huber','sem.ut.cursus@auctornonfeugiat.org','1-783-311-9523','Martes'),
        ('OABJ721225821','Ryder','Mejia','Cabrera','non.lobortis@justonec.ca','1-410-570-0091','Miercoles'),
        ('AAD1012087SA','Whitney','Finch','Bradshaw','enim.Sed@nullavulputatedui.edu','1-938-212-0658','Jueves'),
        ('ERM140613MR4','Beatrice','Moreno','Sharp','tempus.non@senectus.org','1-865-770-8023','Viernes'),
        ('CASC730317U43','Upton','Gonzalez','Acevedo','velit@Praesentluctus.co.uk','1-243-167-6824','Sabado'),
        ('OFC1207307K1','Branden','Mclean','Montgomery','dolor.Quisque@eget.com','1-309-708-8616','Domingo'),
        ('GCO130715PWA','Deacon','Andrews','Tyler','Sed.nec@tinciduntaliquamarcu.ca','1-236-902-5402','Lunes'),
        ('FIMA681230JN4','Kyra','Hanson','Puckett','Sed.auctor@dapibusidblandit.ca','365-9371','Martes'),
        ('PESA750228IN6','Kermit','Bauer','Charles','cubilia@tincidunt.edu','1-762-117-4957','Miercoles'),
        ('CUPX821127BG6','Iris','Thompson','Branch','massa.rutrum@quis.com','1-942-616-8986','Jueves'),
        ('IAC091127D43','Jillian','Rosario','Mueller','ligula@velmaurisInteger.org','850-5718','Viernes'),
        ('GGA750224K13','Nissim','Puckett','Finley','sit@duiFuscealiquam.org','554-1204','Sabado'),
        ('GATL740803MQ1','Brian','Kim','Moody','felis@malesuadamalesuadaInteger.ca','1-219-111-8201','Domingo'),
        ('EVI060613AE2','Riley','Bird','Chandler','Vivamus.nisi.Mauris@Quisque.org','1-180-571-2190','Lunes'),
        ('ECA930216597','Noelani','Sosa','Ramirez','sit@Aliquamfringillacursus.edu','1-998-712-5473','Martes'),
		('RSI051223EIA','Meghan','Santiago','Cardenas','in@necanteblandit.edu','1-375-835-2932','Lunes'),
        ('ASE1101319U8','Alvin','Parker','Mack','quam.a@sedconsequatauctor.com','1-223-728-5625','Martes'),
        ('FIMA810616UJ6','Haley','Harrington','Robbins','dui.augue.eu@NullafacilisisSuspendisse.edu','1-442-447-3638','Miercoles'),
        ('XES091026UH0','Jordan','Duran','Cross','nulla.Cras.eu@eu.org','865-2121','Jueves'),
        ('DME0205279YA','Illiana','Sloan','Terry','interdum.Nunc@Cum.co.uk','1-508-435-2387','Viernes'),
        ('FME7609068N7','Ramona','Ochoa','Dudley','Fusce@anuncIn.org','367-0764','Sabado'),
        ('GCA080118QX5','Veronica','Kidd','Strong','Suspendisse.non.leo@Phasellus.co.uk','1-569-398-4067','Domingo'),
        ('HEAF640219J10','Porter','Donaldson','Duran','tristique@nonmagnaNam.net','998-5185','Lunes'),
        ('VIS091119IK0','Miriam','Blevins','Santiago','blandit.enim@hendreritid.com','867-1362','Martes'),
        ('VWA061012KL9','Seth','Villarreal','Meyers','ac@vulputate.com','1-995-282-1086','Miercoles'),
        ('CCO140114EB5','Miriam','Trujillo','Hendrix','lectus.quis.massa@egestasblandit.edu','1-701-830-3696','Jueves'),
        ('HSP0309255Q6','Signe','Burns','Marquez','sit.amet.ornare@arcuvel.org','983-2031','Viernes'),
        ('EEU930201289','Solomon','Mcfarland','Hampton','sit.amet@venenatis.co.uk','295-7618','Sabado'),
        ('GCE140116L3A','Boris','Cantrell','Stout','enim.gravida@ornare.co.uk','1-599-520-3682','Domingo'),
        ('AUPM820917LN6','Ocean','Butler','Hoover','lorem@dictumcursusNunc.co.uk','1-511-996-3071','Lunes'),
        ('TEX0507151K4','Ocean','Butler','Hoover','lorem2@dictumcursusNunc.co.uk','1-511-996-3071','Martes'),
        ('MPG941109JTA','Ocean','Butler','Hoover','lorem@dictumcursusNunc.co.uk','1-511-996-3071','Miercoles'),
        ('GME920101B39','Ocean','Butler','Hoover','lorem@dictumcursusNunc.co.uk','1-511-996-3071','Jueves'),
        ('VARJ791105KI0','Ocean','Butler','Hoover','lorem@dictumcursusNunc.co.uk','1-511-996-3071','Viernes'),
        ('RSB820604JD5','Ocean','Butler','Hoover','lorem@dictumcursusNunc.co.uk','1-511-996-3071','Sabado'),
        ('INM0805298K1','Ocean','Butler','Hoover','lorem@dictumcursusNunc.co.uk','1-511-996-3071','Domingo'),
        ('MUN141126IF8','Porter','Donaldson','Duran','tristique@nonmagnaNam.net','998-5185','Lunes'),
        ('GJA900820PC9','Porter','Donaldson','Duran','tristique@nonmagnaNam.net','998-5185','Martes'),
        ('SME081013379','Porter','Donaldson','Duran','tristique@nonmagnaNam.net','998-5185','Miercoles'),
        ('VCO080307GZ8','Porter','Donaldson','Duran','tristique@nonmagnaNam.net','998-5185','Jueves'),
        ('GOPJ7104289U0','Porter','Donaldson','Duran','tristique@nonmagnaNam.net','998-5185','Viernes'),
        ('ERE120329EG5','Porter','Donaldson','Duran','tristique@nonmagnaNam.net','998-5185','Sabado'),
        ('MAGL710830T23','Porter','Donaldson','Duran','tristique@nonmagnaNam.net','998-5185','Domingo'),
        ('GQU821028223','Porter','Donaldson','Duran','tristique@nonmagnaNam.net','998-5185','Lunes'),
        ('SNC060407LD6','Porter','Donaldson','Duran','tristique@nonmagnaNam.net','998-5185','Martes'),
        ('MOEJ900409694','Ocean','Butler','Hoover','lorem@dictumcursusNunc.co.uk','1-511-996-3071','Lunes');
